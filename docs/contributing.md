...
`corr-solver` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/corr-solver
[issue tracker]: https://github.com/<USERNAME>/corr-solver/issues
