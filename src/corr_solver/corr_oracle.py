...
3. ``construct_distance_matrix`` / ``construct_poly_matrix`` build the distance
   and polynomial-basis matrices consumed by the oracles.
4. ``corr_poly`` fits a polynomial to ``Y`` via a cutting-plane oracle and
